...
.animate-zoom { animation: zoomIn 0.7s ease forwards; }
...
with col1:
    st.markdown(f"""
    <div class="kpi-card animate-zoom delay-1">
...
with col2:
    ...
    st.markdown(f"""
    <div class="kpi-card animate-zoom delay-2">
...
with col3:
    ...
    st.markdown(f"""
    <div class="kpi-card animate-zoom delay-3">
...
with col4:
    st.markdown(f"""
    <div class="kpi-card animate-zoom delay-4">
...
st.markdown('<div class="section-title animate-up">🕯 Candlestick Charts — Top Coins</div>', unsafe_allow_html=True)
...
with col1:
    st.markdown('<div class="section-title animate-left">🏆 Market Cap Leaders</div>', unsafe_allow_html=True)
...
with col2:
    st.markdown('<div class="section-title animate-right">📈 24h Price Change</div>', unsafe_allow_html=True)
...
with col1:
    st.markdown('<div class="section-title animate-left">💧 Volume Comparison</div>', unsafe_allow_html=True)
...
with col2:
    st.markdown('<div class="section-title animate-right">⚡ Volatility Ranking</div>', unsafe_allow_html=True)
...
st.markdown('<hr class="divider">', unsafe_allow_html=True)
st.markdown('<div class="section-title animate-up">📋 Live Market Data</div>', unsafe_allow_html=True)
